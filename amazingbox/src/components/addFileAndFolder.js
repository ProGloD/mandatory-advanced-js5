        ...
        <div className="add-menuContainer">
            ...
            <div className="modal__shadow">
                <div className="modal__shadow__container">
                    <input className="modal__shadow__input" type="text" onChange={(e)=> {state.inputValue = e.target.value; console.log(state.inputValue)}} required></input>
            ...
            <label className="custom-file-label material-icons" htmlFor="inputGroupFile01">insert_drive_file</label>
            <button className="add-folderButton material-icons" onClick={()=>dispatch({type: "show_create_folder"})}>create_new_folder</button></div> : null}
